...
<body onload="initDoc();" onkeypress="submitDefault(event);">
	<form action="${_sysApplication_.goToUrl}/loginAction!login.action"
						...
						<li>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td colspan="2"><amway:textfield id="userCode"
											name="loginVo.userCode" size="25" style="width:160px"
											value="${loginVo.userCode}" dataType="Require" maxLine="128"
											msg="用户名不能为空！" cssClass="login_input" />
										<div class="input_msg">${userCodeMsg }</div></td>
								</tr>
								<tr>
									<td height="35" align="right" class="white">密码：</td>
									<td colspan="2"><input type="password" id="password"
										name="loginVo.password" size="25" style="width: 160px"
										dataType="Require" maxlength="256" msg="密码不能为空！"
										class="login_input" />
										<div class="input_msg">${passwordMsg }</div></td>
								</tr>
								<tr>
									<td height="35" align="right" class="white">选择应用：</td>
									<td colspan="2"><amway:select id="applicationCode"
											name="loginVo.applicationCode" dictCode="app_001"
											listKey="applicationCode" listValue="applicationName"
											...
											dataType="Require" msg="应用不能为空" style="width:160px" /> <input
										type="button" value="搜索"
										onclick="popup(600,500,'${_sysApplication_.goToUrl}/applicationAction!popup.action')" />
										<div class="input_msg">${applicationCodeMsg }</div></td>
								</tr>
								<tr id="kaptcha_tr" style="display: none">
									<td height="35" align="right" class="white">验证码：</td>
									<td width="18%"><amway:textfield id="kaptcha"
											name="loginVo.kaptcha" cssClass="login_input" size="8"
											maxLine="6" cssClass="login_input" />
										<div class="input_msg">${kaptchaMsg }</div></td>
									<td width="68%"><img width="100" height="30"
										id="kaptchaId" src="${_sysApplication_.goToUrl}/Kaptcha.jpg" />
									</td>
								</tr>
								<tr id="kaptcha_tr2" style="display: none">
									<td height="30" align="right" class="white">&nbsp;</td>
									<td colspan="2"><a href="#"
										onclick="changeKaptcha('kaptchaId')" class="blue"
										style="text-decoration: underline;">看不清楚？ 换一个</a></td>
								</tr>
								<tr>
									<td height="35" align="right" class="white">&nbsp;</td>
									<td colspan="2"><a href="#"
										onclick="javascript:cancel('resetId');cleanMsgs();document.getElementById('userCode').focus();"><img
											src="${_sysApplication_.goToUrl}/common/images/login_btm_${_amwayCss_}.gif" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
										<input id="resetId" type="reset" style="display: none" /> <a
										href="#" onclick="login('submitId');"><img
											src="${_sysApplication_.goToUrl}/common/images/login_btm2_${_amwayCss_}.gif" /></a>
										<input id="submitId" type="submit" style="display: none" /></td>
								</tr>
							</table>
						</li>
					</ul>
