 ...
 * Created by MyElipse
 * 
 * @author huangweijin Date: 2011-3-22 Time: 10:47:54 Declare：应用常量接口
 */
public interface AppConstant {
    ...
    public static final String DATASOURCE_NAME_APP = "jdbcamwayApp";
    ...
    // 持久化单元
    public static final String JPA_DB_UNIT = "MYSQLPU";

    public static final String JPA_DB_UNIT_APP = "PUAPP";
    ...
    public static final Integer RET_MAX_NUM = 3000;
